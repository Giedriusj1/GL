...
marchingCube::marchingCube(){
  ...
  // memset((GLfloat *) m_TriangleVertexArray, '0' , sizeof(m_TriangleVertexArray) * arrSize * arrSize * arrSize);
  ...
  for(int x=1; x<arrSize-1; x++){
	...
	int cubeindex = 0;
	if (scalMap[x][y][z+1]     == true) cubeindex |= 1;
	if (scalMap[x+1][y][z+1]   == true) cubeindex |= 2;
	if (scalMap[x+1][y][z]     == true) cubeindex |= 4;
	if (scalMap[x][y][z]       == true) cubeindex |= 8;
	if (scalMap[x][y+1][z+1]   == true) cubeindex |= 16;
	if (scalMap[x+1][y+1][z+1] == true) cubeindex |= 32;
	if (scalMap[x+1][y+1][z]   == true) cubeindex |= 64;
	if (scalMap[x][y+1][z]     == true) cubeindex |= 128;
