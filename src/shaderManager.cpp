...
void shaderManager::attachShader(const std::string shaderName,
                                 GLenum shaderType) {
...
void shaderManager::linkShaders() {
  ...
  // std::cout << (status ? "Program linked!" : "Program could not be linked")
  // << std::endl;
}

GLuint shaderManager::getProgram() { return programObject; }
